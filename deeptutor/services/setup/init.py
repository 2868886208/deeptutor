...
DEFAULT_AGENTS_SETTINGS = {
    "capabilities": {
        ...
        "research": {"temperature": 0.5, "max_tokens": 12000, "model": None},
        "question": {"temperature": 0.7, "max_tokens": 4096, "model": None},
        "co_writer": {"temperature": 0.7, "max_tokens": 4096, "model": None},
        "visualize": {"temperature": 0.4, "max_tokens": 16384, "model": None},
        "chat": {
            "temperature": 0.2,
