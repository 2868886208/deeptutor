...
_SIMPLE_LLM_DEFAULTS: dict[str, dict[str, Any]] = {
    "solve": {"temperature": 0.3, "max_tokens": 8192, "model": None},
    "research": {"temperature": 0.5, "max_tokens": 16834, "model": None},
    "question": {"temperature": 0.7, "max_tokens": 4096, "model": None},
    "co_writer": {"temperature": 0.6, "max_tokens": 4096, "model": None},
    "vision_solver": {"temperature": 0.3, "max_tokens": 12000, "model": None},
    "math_animator": {"temperature": 0.2, "max_tokens": 16834, "model": None},
}
...
def _apply_simple_llm_into_agents_yaml(
    ...
    if "model" in block:
        new_section["model"] = block.get("model")
...
def get_research_params() -> dict[str, Any]:
    """Runtime research params (temperature, max_tokens, model) from agents.yaml."""
    agents_cfg = _read_agents_yaml()
    return _build_simple_llm_block(agents_cfg, "research")
